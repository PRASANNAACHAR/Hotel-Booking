...
const Dashboard = () => {
  ...
  return (
    <div>
        <Title align='left' font='outfit' title='Dashboard' subTitle='Monitor Your room listings, track bookings and analyze-all in one place. Stay updated with real-time insights to ensure smooth operations.' />
