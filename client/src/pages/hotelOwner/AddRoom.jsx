...
const AddRoom = () => {
  ...
  return (
    <form>
       <Title align='left' font='outfit' title='Add Room' subTitle='Fill in the details carefully and accurate room deatils, pricing , and amenities , to enhance the user booking experience.' />
